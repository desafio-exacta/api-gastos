...
public class GastoController {
	...
	@DeleteMapping(path = "api/gastos/{id}")
	public void delete(@PathVariable("id") long id) {
		service.delete(id);
	}
	
	@PutMapping(path = "api/gastos/{id}", consumes = "application/json", produces = "application/json")
	public void update(@PathVariable("id") long id, @RequestBody Gasto gasto) {
		service.update(id, gasto);
	}
}
